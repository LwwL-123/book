...
![image](https://picture-1258612855.cos.ap-shanghai.myqcloud.com/20220325172150.png)

上图表示一个坑一个萝卜的内存读取方式。但实际上 CPU 并不会以一个一个字节去读取和写入内存。相反 CPU 读取内存是**一块一块读取**的，块的大小可以为 2、4、6、8、16 字节等大小。块大小我们称其为**内存访问粒度**。如下图：

![image](https://picture-1258612855.cos.ap-shanghai.myqcloud.com/20220325172152.png)
...
![image](https://picture-1258612855.cos.ap-shanghai.myqcloud.com/20220325172157.png)
